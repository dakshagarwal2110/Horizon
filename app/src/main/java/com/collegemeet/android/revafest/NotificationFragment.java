...
public class NotificationFragment extends Fragment implements SharedPreferences.OnSharedPreferenceChangeListener {


    private static final String TAG = "MyTag";
    private RecyclerView recyclerView;
    private NotificationAdapterClass adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.notification_feed_recycler_view);
        ...
        adapter = new NotificationAdapterClass(getContext(), list);
        recyclerView.setAdapter(adapter);
        refreshLayout = view.findViewById(R.id.refreshNotificationFeed);
    ...
    private void fetchVlogs() {
        ...
        if (key == null) {
            ...
            firestore.collection("users").document(uid)
                    .collection("notifications").orderBy("eventName", Query.Direction.DESCENDING).limit(1).addSnapshotListener((value, error) -> {
            ...
            firestore.collection("users").document(uid)
                    .collection("notifications").orderBy("eventName", Query.Direction.DESCENDING).startAfter(key).limit(1)
